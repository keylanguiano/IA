    ...
    do
    {
        ...
        switch (opcion) {
            case '1':
				...
				if (fs::exists("FONT_FEATURES_2.1.csv")) {
					cout << "EL ARCHIVO FONT_FEATURES_2.1.csv YA EXISTE EN LA CARPETA RAIZ." << endl;
            ...
            case '2':
                ...
                if (!fs::exists("FONT_FEATURES_2.1.csv")) {
					...
					loadFeaturesFromCSV("FONT_FEATURES_2.1.csv", fullFeatures, originalLabels);
            ...
            case '3':
				...
				if (fs::exists("ANNfontTypesClassifierModel_2.1.yml")) {
					cout << "EL ARCHIVO ANNfontTypesClassifierModel_2.1.yml YA EXISTE EN LA CARPETA RAIZ." << endl;
					cout << "DESEA SOBREESCRIBIRLO? (S/N): ";
					cin >> overwrite;
				...
				filename_ANNmodel = (char*)"ANNfontTypesClassifierModel_2.1.yml";
            ...
            case '4':
				...
				if (!fs::exists("ANNfontTypesClassifierModel_2.1.yml")) {
					cout << "EL ARCHIVO ANNfontTypesClassifierModel_2.1.yml NO EXISTE EN LA CARPETA RAIZ." << endl;
...
void processImagesAndSaveFeatures() {
    ...
    bool success = saveToCSV("FONT_FEATURES_2.1.csv", data, labels);

    if (success)
        cout << "\nCARACTERISTICAS GUARDADAS EN EL ARCHIVO: FONT_FEATURES_2.1.csv" << endl;
}
