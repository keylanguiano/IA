    ...
    do
    {
        ...
        switch (opcion) {
            case '1':
				...
				if (fs::exists("FONT_FEATURES_2.3.csv")) {
					cout << "EL ARCHIVO FONT_FEATURES_2.3.csv YA EXISTE EN LA CARPETA RAIZ." << endl;
            ...
            case '2':
                ...
                if (!fs::exists("FONT_FEATURES_2.3.csv")) {
					cout << "EL ARCHIVO FONT_FEATURES_2.3.csv NO EXISTE EN LA CARPETA RAIZ." << endl;
					cout << "POR FAVOR EJECUTE LA OPCION 1 PARA CREARLO." << endl;
					system("pause");
					break;
                }
                else {
					loadFeaturesFromCSV("FONT_FEATURES_2.3.csv", fullFeatures, originalLabels);
            ...
            case '3':
				...
				if (fs::exists("ANNfontTypesClassifierModel_2.3.yml")) {
					cout << "EL ARCHIVO ANNfontTypesClassifierModel_2.3.yml YA EXISTE EN LA CARPETA RAIZ." << endl;
					cout << "DESEA SOBREESCRIBIRLO? (S/N): ";
					cin >> overwrite;
				...
				filename_ANNmodel = (char*)"ANNfontTypesClassifierModel_2.3.yml";
            ...
            case '4':
				...
				if (!fs::exists("ANNfontTypesClassifierModel_2.3.yml")) {
					cout << "EL ARCHIVO ANNfontTypesClassifierModel_2.3.yml NO EXISTE EN LA CARPETA RAIZ." << endl;
...
void processImagesAndSaveFeatures() {
    ...
    bool success = saveToCSV("FONT_FEATURES_2.3.csv", data, labels);

    if (success)
        cout << "\nCARACTERISTICAS GUARDADAS EN EL ARCHIVO: FONT_FEATURES_2.3.csv" << endl;
}
...
int ANN_MLP_CreateBasic (Ptr <ml::ANN_MLP> & ann, int nFeatures, int nClasses)
{
    ...
    ann -> setTermCriteria (TermCriteria (TermCriteria::MAX_ITER + TermCriteria::EPS, 2000, 0.000001));
